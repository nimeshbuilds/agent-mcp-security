...
Scan ID: `a887c14b7552ad8abe222f833db89489daf0970e54765d10b27b258384819bcb`
...
```text
{
  ...
  "source_and_packaged_file_scope": {
    ...
    "review_config_sha256": "4dc93595be2eae6cc393531fa91f41465ead3384f77c76fb1caa0bc8833a218b"
  }
}
```
...
```json
{
  "items": [
    ...
    },
    {
      ...
      "kind": "finding",
      "reason": "EXAMPLE ONLY: package pinning is assessed by the separate release pipeline control.",
      "reviewed_at": "",
      "reviewer": "Explicit review configuration",
    ...
    },
    {
      ...
      "kind": "finding",
      "reason": "EXAMPLE ONLY: the owner reviewed the deployed image identity and recorded the exception in the release assessment.",
      "reviewed_at": "",
      "reviewer": "Explicit review configuration",
    ...
    },
    {
      ...
      "id": "check:GOV-01:1",
      "kind": "check",
      "reason": "EXAMPLE ONLY: inventory governance is outside this selected engineering review.",
      "reviewed_at": "",
      "reviewer": "Explicit review configuration",
    ...
    },
    {
      ...
      "id": "check:AUTH-01:2",
      "kind": "check",
      "reason": "EXAMPLE ONLY: owner-reviewed authentication evidence is recorded in the external assessment.",
      "reviewed_at": "",
      "reviewer": "Explicit review configuration",
  ...
  "origin": {
    ...
    "scan_id": "a887c14b7552ad8abe222f833db89489daf0970e54765d10b27b258384819bcb",
