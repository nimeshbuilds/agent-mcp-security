...
Scan ID: `3aee3f5aad12ec331e99499fa4662eb21877841e2075c652fdc44c401e4306d4`
...
The scanner found 7 open critical/high patterns among 10 open findings\. Confirm exposure and prioritize the actions below\. Detector severity is not proof of exploitability or deployed risk\.
...
**What the scanner found:** Supply chain: 2; Tool execution: 2; Transport security: 2; Agent permissions: 1; Deserialization: 1; Sandboxing: 1; Secrets: 1. These are detected pattern categories, not confirmed attack paths.
...
<a id="group-f2d4845a78f7"></a>

### AI002: Dynamic command executed through a shell

**HIGH** · justified · 1 occurrences · source
...
| findings | 979d192981c1785a2394fe19 | justified | TEST ONLY: deliberate inert fixture retained for scanner regression\. This assertion validates no production safeguard\. |

Review configuration SHA-256: `465365cee27f267d542b1f7f62a158d5c7cef210a8ff1f7a4a22b2a251ad55fb`.
...
```text
{
  ...
  "source_and_packaged_file_scope": {
    ...
    "review_config_sha256": "465365cee27f267d542b1f7f62a158d5c7cef210a8ff1f7a4a22b2a251ad55fb"
  }
}
```
...
Scanned **3 files**; **10 open findings**, **0 suppressed findings**, and **0 coverage gaps**.
...
**User decision:** justified (finding 979d192981c1785a2394fe19). **Reason:** TEST ONLY: deliberate inert fixture retained for scanner regression\. This assertion validates no production safeguard\.
...
Open finding IDs: 0fa7e450cd583d78646ef397

Justified finding IDs: 979d192981c1785a2394fe19
- [Source](https://owasp.org/projects/mcp-top-10)
...
```text
{
  ...
  "incomplete": false,
  "not_redetected": [],
  "origin_scan_id": "30b207d5b14b0ab9ac85d3a22cd28dcef884cfa9f9bdcdac93bb4326b9351884",
  "out_of_scope": [],
  "source_sha256": "e0271c845ceabf47c64b14c804425b9b458a6ac5714ad5826559341145115e41",
  "stale": [],
  "status": "completed",
  "unresolved": []
}
...
```json
{
  ...
  "origin": {
    ...
    "scan_id": "3aee3f5aad12ec331e99499fa4662eb21877841e2075c652fdc44c401e4306d4",
