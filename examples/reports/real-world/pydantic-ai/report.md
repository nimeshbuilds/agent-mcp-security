...
Scan ID: `ba074839e9c4504f33005a5a72414c58b9cd25abdc73d2994d18c4ab1ccf5025`
...
- analysis\_error: ValueError while reading or analyzing file: 2 entries. Examples: pydantic\_ai\_slim/pydantic\_ai/models/anthropic\.py, pydantic\_ai\_slim/pydantic\_ai/models/openai\.py
...
Scanned **386 files**; **0 open findings**, **0 suppressed findings**, and **2 coverage gaps**.

| Critical | High | Medium | Low | Info |
|---:|---:|---:|---:|---:|
| 0 | 0 | 0 | 0 | 0 |

Source I/O: **8414725 bytes read**, **8414725 bytes charged** against the budget, including **0 conservatively charged bytes** for failed reads. Each read reserves a sentinel byte to detect growth.
...
|---|---:|---|
| configuration\_lexical | 5 | Selected text/configuration patterns; YAML anchors, block\-scalar semantics and dynamic templates are not fully resolved\. |
...
| python\_ast | 380 | Python syntax, bounded local aliases/value tracking and selected security sinks; no whole\-program or interprocedural proof\. |
...
Dependency manifests: 6; agent/MCP signal files: 10.

Dependency manifests are inventoried, not checked against a vulnerability database.

### Scan errors

- pydantic\_ai\_slim/pydantic\_ai/models/anthropic\.py: ValueError while reading or analyzing file
- pydantic\_ai\_slim/pydantic\_ai/models/openai\.py: ValueError while reading or analyzing file
