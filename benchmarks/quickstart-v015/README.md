...
Status: **passed**. Scanner: **0.15.0**. Python: **3.12.14**.
...
| installed_terminal_default | 0 | passed |
| installed_scan_inventory | 0 | passed |
| installed_scan_explanation | 0 | passed |
| installed_permission_explanation | 0 | passed |
| installed_investigation_help | 0 | passed |
| installed_targeted_terminal | 1 | passed |
| installed_review_only_control | 0 | passed |
| installed_explicit_report | 0 | passed |
| installed_selected_image | 0 | passed |
| installed_skill_fixture | 1 | passed |
