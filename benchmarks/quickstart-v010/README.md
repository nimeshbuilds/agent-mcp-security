...
Status: **passed**. Scanner: **0.10.0**. Python: **3.12.14**.
...
| direct_safer | 0 | passed |
| direct_vulnerable | 1 | passed |
| direct_image | 1 | passed |
| direct_review_config | 1 | passed |
