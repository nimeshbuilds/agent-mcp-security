...
def main() -> None:
    ...
    for guide in ("setup", "01-explore", "02-source", "03-skills", "04-scope", "05-images", "06-ci", "07-exceptions", "08-review", "09-gateways", "10-provider-cli"):
        if "docs/walkthroughs/" + guide + "/index.html" not in pages:
            errors.append("Scenario walkthrough absent: " + guide)
